...
function buildHeader(activePage) {
  const nav = [
    ...
    { label: 'Туры',         href: 'tours.html',   id: 'tours', hot: true },
    { label: 'Карта мира',   href: 'map.html',     id: 'map' },
    { label: 'Отели',        href: 'hotels.html',  id: 'hotels' },
    { label: 'Акции',        href: 'deals.html',   id: 'deals' },
    { label: 'О нас',        href: 'about.html',   id: 'about' },
  ];
  const navHTML = nav.map(n => `
    <li>
      <a href="${n.href}" class="nav-link${n.id === activePage ? ' active' : ''}" id="nav-${n.id}">
        ${n.label}${n.hot ? '<span class="hot-badge">HOT</span>' : ''}
      </a>
    </li>`).join('');

  return `
<div class="notif-bar" id="notif-bar">
  🔥 Горячие скидки до −40%! <a href="deals.html">Смотреть акции →</a>
...
<header class="site-header" id="site-header">
  <div class="header-inner">
    ...
    <div class="header-right">
      ...
      <a href="#" class="btn-login" id="btn-login" onclick="event.preventDefault();openAuthModal('login')">Войти</a>
      <div id="user-area"></div>
      <a href="tours.html" class="btn-header-cta" id="btn-header-cta">Найти тур</a>
    </div>
...
<footer class="site-footer" id="site-footer">
  <div class="footer-inner">
    <div class="footer-top">
      <div class="footer-brand">
        <a href="index.html" class="logo-link">
          <img src="assets/logo.png" alt="Endless Line" class="logo-img" style="height:32px">
          <div class="logo-text">
            <span class="logo-name">Endless</span>
            <span class="logo-name-accent">Line</span>
          </div>
        </a>
        <p class="footer-tagline">Ваш надёжный партнёр в мире путешествий. Туры в 50+ стран мира с гарантией лучшей цены.</p>
        <div class="footer-socials">
          <a href="#" class="footer-social-btn" aria-label="Instagram" id="f-instagram">
          ...
          <a href="#" class="footer-social-btn" aria-label="Telegram" id="f-telegram">
          ...
          <a href="#" class="footer-social-btn" aria-label="WhatsApp" id="f-whatsapp">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
          </a>
          <a href="#" class="footer-social-btn" aria-label="YouTube" id="f-youtube">
    ...
    <div class="footer-bottom">
      <p class="footer-copy">© 2026 Endless Line. Все права защищены.</p>
